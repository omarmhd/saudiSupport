        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            ...
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have {{auth()->user()->readNotifications()->count()}} unread Notifications</p>
                        </div>
                        <div class="main-notification-list Notification-scroll" style="overflow: scroll">

                            @foreach(auth()->user()->notifications as $notification)

                                <a class="d-flex p-3 border-bottom" href="{{route('notification',$notification->id)}}" style="background: {{$notification->read_at==null?"#ECF0FA":"" }} ">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt="" src="{{asset('assets/businessman.png')}}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt="" src="{{asset('assets/businessman.png')}}" class=""></div>
