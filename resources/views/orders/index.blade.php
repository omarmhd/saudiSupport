                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap dataTable no-footer table-bordered" id="example1_wrapper" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <th class="wd-20p border-bottom-0">Track no</th>
                                <th class="wd-20p border-bottom-0">type order</th>

                                <th class="wd-20p border-bottom-0">details</th>
                                <th class="wd-20p border-bottom-0">order_journey</th>
                                <th class="wd-20p border-bottom-0">note</th>
                                <th class="wd-20p border-bottom-0">attachments</th>
